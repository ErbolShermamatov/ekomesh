      ...
      <div className="container">
        <div className="production__header">
          <h2 className="production__title">
            Собственное производство в&nbsp;Оше
          </h2>
          <p className="production__subtitle">
            Линейка промышленных котлов «ЭКО-МЕШ» мощностью от 0.12 МВт до 3.0
            МВт готовы к отправке по всему Кыргызстану.
          </p>
        </div>

        <div className="production__navigation-wrapper">
          <button
            className="production__nav production-prev"
              ...
              <SwiperSlide key={index}>
                <div className="production-slide">
                  <img
                    loading="lazy"
                    src={img}
                    alt={`Цех Стройматпром ${index + 1}`}
                    className="production-slide-img"
                  />
                </div>
              </SwiperSlide>
            ))}
          ...
          <button
            className="production__nav production-next"
